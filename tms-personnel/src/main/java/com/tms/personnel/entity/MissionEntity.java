...
public class MissionEntity implements Serializable {
    ...
    private Double colisHauteur; // mètres

    @Column(name = "colis_largeur")
    private Double colisLargeur; // mètres

    @Column(name = "colis_longueur")
    private Double colisLongueur; // mètres

    @Column(name = "volume_total")
    private Double volumeTotal; // m³ = nombre * hauteur * largeur * longueur

    @Column(name = "statut")
    @Builder.Default
    private String statut = "EN_COURS"; // EN_COURS, TERMINEE, ANNULEE
